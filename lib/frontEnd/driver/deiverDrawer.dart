...
class MyDriverDrawer extends StatefulWidget {
  _BirdState createState() => new _BirdState();
}

class _BirdState extends State<MyDriverDrawer> {
...
String name;
  checkStorge() async {
    ClientModel clientModel =
        ClientModel.fromJson(await readerItem("DriverModels"));
    setState(() {
      // model = clientModel;
              ...
              children: <Widget>[
                ...
                new Container(
                  ...
                  child: new Text(
                    ...
                    style: TextStyle(
                      color:
                          _item.isSelected ? Color.fromRGBO(116, 189, 242, 1.0) : Colors.black54,
                    ),
                  ),
                )
              ],
