...
class DriverCurrentOrderPage extends StatefulWidget {
  final String driverId;

  const DriverCurrentOrderPage(this.driverId);
  @override
  _OrderPageState createState() => _OrderPageState();
}

class _OrderPageState extends State<DriverCurrentOrderPage> {
            ...
            ? Container(
                child: StreamBuilder(
                    stream: Stream.fromFuture(
                        getDriverCurrentOrders(widget.driverId.toString())),
