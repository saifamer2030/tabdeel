...
class DriverNotificationsPage extends StatefulWidget {
  ...
  const DriverNotificationsPage(this.driverModel);
...
class _OrderPageState extends State<DriverNotificationsPage> {
                                                ...
                                                MaterialPageRoute(
                                                    builder: (BuildContext
                                                        ...
                                                        DeliveryDetalse(
                                                            ...
                                                            orders[index]
                                                                .clientID,
                                                           widget.driverModel.deviceID.toString(),
